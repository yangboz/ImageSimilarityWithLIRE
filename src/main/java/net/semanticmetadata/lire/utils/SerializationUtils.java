...
public class SerializationUtils {
     ...
     * @see SerializationUtils#toBytes(int)
     */
     ...
     * @see SerializationUtils#toInt(byte[])
     */
     ...
     * {@link SerializationUtils#toFloat(byte[])} to decode.
     *
     * @param data the float to convert
     * @return the resulting byte array
     * @see SerializationUtils#toFloat(byte[])
     */
     ...
     * and fast way by shifting without using streams (which is kind of slow). Use
     * {@link SerializationUtils#toBytes(float)} to encode.
     *
     * @param data the input byte array
     * @return the resulting float
     * @see SerializationUtils#toBytes(float)
     */
     ...
     * and fast way by shifting without using streams (which is kind of slow). Use
     * {@link SerializationUtils#toBytes(double)} to encode. Note that there is a loss
     * in precision as the double is converted to a float in the course of conversion.
     *
     * @param data the input byte array
     * @return the resulting float
     * @see SerializationUtils#toBytes(double)
     */
